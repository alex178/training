...
# unterstuetzt Websocket-Protokoll RFC 6455
...
class EchoWebsocketServer(tornado.websocket.WebSocketHandler):
    ...
    # hier kann die Herkunft der Daten eingeschraenkt werden, siehe naechste untere Methode als Bsp.
    ...
    # Hier werden Nachrichten vom WebsocketClient empfangen
    # in message steht die Nachricht und kann weiter gehandelt werden
    # hier wird die empfangene Nachricht zurueck zum Client gesendet
    def on_message(self, message):
        self.write_message(u"You said: " + message)
        print("angekommene Nachricht " + message)
        EchoWebsocketServer.broadcast("Server: du hast " + message + " geschickt")

    # Wenn WebsocketClient verbindung beendet,
...
if __name__ == "__main__":
    ...
    # IP-Adresse ueber socket-Modul holen
